...
{
    [Area("Admin")] // Контролерът е част от Admin зоната
    public class CategoriesController : Controller
    {
        ...
        // Показва информация за избрана категория
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Category category)
        {
            if (ModelState.IsValid)
            {
                ...
                await _context.SaveChangesAsync(); // Записва в базата
        ...
        // Запазва редактираната категория
        [HttpPost]
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Category category)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    // Проверява дали категорията още съществува
        ...
        // Проверява дали категорията съществува
