...
namespace EternityX.Areas.Admin.Controllers
{
    ...
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId,Count,Price")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderId,ProductId,Count,Price")] OrderItem orderItem)
        {
            if (id != orderItem.Id)
            {
                return NotFound();
